...
export const RecommendationCard = (props) => {
  ...
  return (
    <div className="mx-auto w-full -translate-y-2 transform rounded-lg bg-gray-800 px-5 pb-10 pt-5 shadow-lg transition ease-in-out hover:scale-105">
      <div className="w-full pb-5 pt-1">
        <div className="border-full mx-auto -mt-16 h-24 w-24 transform overflow-hidden rounded-full border-4 border-yellow-400 shadow-lg transition duration-300 ease-in-out hover:scale-110">
      ...
      <div className="w-full">
        <svg
          ...
          viewBox="0 0 48 48"
          className="relative left-0 top-0 h-12 w-12 translate-x-2 translate-y-6 transform fill-current text-white opacity-10"
        >
        ...
        <p className="text-md mx-8 px-5 text-center font-secondary text-gray-300 sm:mx-16">
          {quote}
        </p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 48 48"
          className="relative left-full h-12 -translate-x-full -translate-y-6 transform  fill-current text-white opacity-10"
        >
      ...
      <div className="w-full">
        <p className="text-center font-primary text-xl font-bold text-blue-500">
          {name}
        </p>
        <p className="text-md text-center font-secondary text-gray-300">
          {designation}
        </p>
      </div>
    </div>
